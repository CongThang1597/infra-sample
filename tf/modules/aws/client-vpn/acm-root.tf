...
#    command = <<-EOT
#      echo "${tls_private_key.root.private_key_pem}" > client.key;
#      echo "${tls_locally_signed_cert.root.cert_pem}" > client.crt;
#      echo "${tls_cert_request.root.cert_request_pem}" > client-1.crt;
#    EOT
#  }
#}
